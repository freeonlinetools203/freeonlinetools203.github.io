...
// =========================================================================
// 12. GLOBAL "VIEW ALL TOOLS" BUTTON
//     Yeh sirf ek button show karega har page par (related tools grid nahi)
// =========================================================================
const globalSitemapHTML = `
<div style="max-width:1200px;margin:30px auto 20px;padding:0 20px;text-align:center;">
  <a href="https://freeonlinetools203.com/sitemap.html" 
     ...
     onmouseover="this.style.transform='translateY(-3px)';this.style.boxShadow='0 12px 28px rgba(20,83,45,0.35)';"
     onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 8px 20px rgba(20,83,45,0.25)';">
    🗺️ View All 240+ Tools
  </a>
</div>
`;
...
// =========================================================================
// END: GLOBAL "VIEW ALL TOOLS" BUTTON
// =========================================================================
